 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,Y){var ee=z.length;z.push(Y);e:for(;0<ee;){var we=ee-1>>>1,ce=z[we];if(0<i(ce,Y))z[we]=Y,z[ee]=ce,ee=we;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var Y=z[0],ee=z.pop();if(ee!==Y){z[0]=ee;e:for(var we=0,ce=z.length,Ce=ce>>>1;we<Ce;){var yn=2*(we+1)-1,vn=z[yn],_n=yn+1,wn=z[_n];if(0>i(vn,ee))_n<ce&&0>i(wn,vn)?(z[we]=wn,z[_n]=ee,we=_n):(z[we]=vn,z[yn]=ee,we=yn);else if(_n<ce&&0>i(wn,ee))z[we]=wn,z[_n]=ee,we=_n;else break e}}return Y}function i(z,Y){var ee=z.sortIndex-Y.sortIndex;return ee!==0?ee:z.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],c=[],h=1,p=null,m=3,E=!1,k=!1,C=!1,P=typeof setTimeout=="function"?setTimeout:null,w=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(z){for(var Y=n(c);Y!==null;){if(Y.callback===null)r(c);else if(Y.startTime<=z)r(c),Y.sortIndex=Y.expirationTime,e(u,Y);else break;Y=n(c)}}function b(z){if(C=!1,_(z),!k)if(n(u)!==null)k=!0,js(D);else{var Y=n(c);Y!==null&&gn(b,Y.startTime-z)}}function D(z,Y){k=!1,C&&(C=!1,w(y),y=-1),E=!0;var ee=m;try{for(_(Y),p=n(u);p!==null&&(!(p.expirationTime>Y)||z&&!R());){var we=p.callback;if(typeof we=="function"){p.callback=null,m=p.priorityLevel;var ce=we(p.expirationTime<=Y);Y=t.unstable_now(),typeof ce=="function"?p.callback=ce:p===n(u)&&r(u),_(Y)}else r(u);p=n(u)}if(p!==null)var Ce=!0;else{var yn=n(c);yn!==null&&gn(b,yn.startTime-Y),Ce=!1}return Ce}finally{p=null,m=ee,E=!1}}var L=!1,T=null,y=-1,I=5,S=-1;function R(){return!(t.unstable_now()-S<I)}function x(){if(T!==null){var z=t.unstable_now();S=z;var Y=!0;try{Y=T(!0,z)}finally{Y?A():(L=!1,T=null)}}else L=!1}var A;if(typeof v=="function")A=function(){v(x)};else if(typeof MessageChannel<"u"){var xt=new MessageChannel,Br=xt.port2;xt.port1.onmessage=x,A=function(){Br.postMessage(null)}}else A=function(){P(x,0)};function js(z){T=z,L||(L=!0,A())}function gn(z,Y){y=P(function(){z(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){k||E||(k=!0,js(D))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return m},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(z){switch(m){case 1:case 2:case 3:var Y=3;break;default:Y=m}var ee=m;m=Y;try{return z()}finally{m=ee}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,Y){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var ee=m;m=z;try{return Y()}finally{m=ee}},t.unstable_scheduleCallback=function(z,Y,ee){var we=t.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?we+ee:we):ee=we,z){case 1:var ce=-1;break;case 2:ce=250;break;case 5:ce=1073741823;break;case 4:ce=1e4;break;default:ce=5e3}return ce=ee+ce,z={id:h++,callback:Y,priorityLevel:z,startTime:ee,expirationTime:ce,sortIndex:-1},ee>we?(z.sortIndex=ee,e(c,z),n(u)===null&&z===n(c)&&(C?(w(y),y=-1):C=!0,gn(b,ee-we))):(z.sortIndex=ce,e(u,z),k||E||(k=!0,js(D))),z},t.unstable_shouldYield=R,t.unstable_wrapCallback=function(z){var Y=m;return function(){var ee=m;m=Y;try{return z.apply(this,arguments)}finally{m=ee}}}})(I0);T0.exports=I0;var GS=T0.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PN{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(RN(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function RN(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const kd="@firebase/app",i_="0.10.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ax(t,e){return zr(t,"POST","/v1/accounts:delete",e)}async function Y1(t,e){return zr(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hT(t){const e=Si(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function J4(t,e,n){if(an(t.app))return Promise.reject(Nn(t));const r=Si(t),o=await Nd(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",oO).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&hT(t),u}),l=await yi._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(l.user),l}function Z4(t,e,n){return an(t.app)?Promise.reject(Nn(t)):uO(zt(t),Ls.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&hT(t),r})}function cO(t,e,n,r){return zt(t).onIdTokenChanged(e,n,r)}function fO(t,e,n){return zt(t).beforeAuthStateChanged(e,n)}function hO(t,e,n,r){return zt(t).onAuthStateChanged(e,n,r)}const Qu="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Sr(kD,PD,"app");var R_=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class As{constructor(e){this._byteString=e}static fromBase64String(e){try{return new As(lt.fromBase64String(e))}catch(n){throw new G(V.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new As(lt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iV(t){t=Ea(t,Ft);const e=Ea(t.firestore,qm);return p4(NI(e),t._key).then(n=>L4(e,t,n))}class O4 extends C4{constructor(e){super(),this.firestore=e}convertBytes(e){return new As(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ft(this.firestore,null,n)}}function sV(t,e,n){t=Ea(t,Ft);const r=Ea(t.firestore,qm),i=b4(t.converter,e);return D4(r,[S4(I4(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,xn.none())])}function D4(t,e){return function(r,i){const s=new Ar;return r.asyncQueue.enqueueAndForget(async()=>ZM(await h4(r),i,s)),s.promise}(NI(t),e)}function L4(t,e,n){const r=n.docs.get(e._key),i=new O4(t);return new BI(t,i,e._key,r,new N4(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){Ms=i})(Ds),vs(new pi("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new qm(new bD(r.getProvider("auth-internal")),new DD(r.getProvider("app-check-internal")),function(c,h){if(!Object.prototype.hasOwnProperty.apply(c.options,["projectId"]))throw new G(V.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ya(c.options.projectId,h)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Sr(C_,"4.6.4",e),Sr(C_,"4.6.4","esm2017")})();var M4={VITE_API_KEY:"AIzaSyAsdeZsuY2CjOVsDXMjX3__4yt4PBWqZN4",VITE_AUTH_DOMAIN:"login-auth-788f2.firebaseapp.com",VITE_PROJECT_ID:"login-auth-788f2",VITE_STORAGE_BUCKET:"login-auth-788f2.appspot.com",VITE_MESSAGING_SENDER_ID:"948308228065",VITE_APP_ID:"1:948308228065:web:5efdbfec8c454896fa04a0",BASE_URL:"/",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const V4={apiKey:"AIzaSyAsdeZsuY2CjOVsDXMjX3__4yt4PBWqZN4",authDomain:"login-auth-788f2.firebaseapp.com",projectId:M4.VITE_APP_PROJECT_ID,storageBucket:"login-auth-788f2.appspot.com",messagingSenderId:"948308228065",appId:"1:948308228065:web:5efdbfec8c454896fa04a0"},F4=j1(V4),U4=SD(),oV=_4(F4),l0=({children:t})=>{const[e,n]=U.useState(null),[r,i]=U.useState(!0);return U.useEffect(()=>{const s=hO(U4,o=>{n(o),i(!1)});return()=>s()},[]),r?q.jsx("div",{children:"Loading..."}):e?t:q.jsx(zP,{to:"/login"})};class j4 extends Ps.Component{constructor(e){super(e),this.state={hasError:!1}}static getDerivedStateFromError(e){return{hasError:!0}}componentDidCatch(e,n){console.error("Error caught in Error Boundary:",e,n)}render(){return this.state.hasError?q.jsx("h1",{children:"Something went wrong."}):this.props.children}}function z4(){const t=U.lazy(()=>Jn(()=>import("./Home-Z6kdip_e.js"),[])),e=U.lazy(()=>Jn(()=>import("./Shoes-Bb7UNVmB.js"),[])),n=U.lazy(()=>Jn(()=>import("./ShoesDetails-DVEYfsdm.js"),[])),r=U.lazy(()=>Jn(()=>import("./Checkout-8iv-eldg.js"),[])),i=U.lazy(()=>Jn(()=>import("./Payment-BXu7nqXK.js"),[])),s=U.lazy(()=>Jn(()=>import("./Login-Bw-KiIp-.js"),[])),o=U.lazy(()=>Jn(()=>import("./Signup-B-ivv73r.js"),[])),l=U.lazy(()=>Jn(()=>import("./UserProfile-CK6EuQpH.js"),[])),u=m1(h=>h.order),c=kb();return U.useEffect(()=>{c(b2.getProducts(Rb))},[c]),U.useEffect(()=>{u&&(async()=>{try{if(!(await fetch("https://codage-69f6a-default-rtdb.asia-southeast1.firebasedatabase.app/order.json",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({order:u})})).ok)throw new Error("Failed to send order data");console.log("Order data sent successfully!")}catch(p){console.error("Error sending order:",p)}})()},[u]),q.jsxs(YP,{children:[q.jsx(Pb,{}),q.jsxs("main",{className:"content",children:[q.jsx(M2,{}),q.jsx(j4,{children:q.jsx(U.Suspense,{fallback:q.jsx("p",{children:"Is loading"}),children:q.jsxs($P,{children:[q.jsx(tn,{path:"/signup",element:q.jsx(o,{})}),q.jsx(tn,{path:"/login",element:q.jsx(s,{})}),q.jsx(tn,{path:"/userprofile",element:q.jsx(l0,{children:q.jsx(l,{})})}),q.jsx(tn,{path:"/",element:q.jsx(t,{})}),q.jsx(tn,{path:"/shoes",element:q.jsx(e,{})}),q.jsx(tn,{path:"/shoes/:gender",element:q.jsx(e,{})}),q.jsx(tn,{path:"/shoes/shoesdetails/:id",element:q.jsx(n,{})}),q.jsx(tn,{path:"/shoes/checkout",element:q.jsx(r,{})}),q.jsx(tn,{path:"/shoes/checkout/payment",element:q.jsx(l0,{children:q.jsx(i,{})})})]})})})]}),q.jsx(L2,{})]})}const $I=Ii({name:"currentpage",initialState:1,reducers:{setCurrentPage(t,e){return e.payload}}}),aV=$I.actions,B4=$I.reducer,WI=Ii({name:"cart",initialState:{items:[],totalQuantity:0,totalPrice:0},reducers:{addToCart(t,e){const n=e.payload,r=t.items.findIndex(i=>i.id===n.id&&i.size===n.size);r===-1?t.items.push({id:n.id,name:n.title,brand:n.brand,imageURL:n.imageURL,price:n.price,totalPrice:n.price*n.quantity,quantity:n.quantity,size:n.size}):(t.items[r].quantity+=n.quantity,t.items[r].totalPrice+=n.price*n.quantity),t.totalQuantity+=n.quantity,t.totalPrice+=n.price*n.quantity},removeFromCart(t,e){const{id:n,size:r}=e.payload,i=t.items.findIndex(s=>s.id===n&&s.size===r);if(i!==-1){const s=t.items[i];s.quantity>1?(s.quantity-=1,s.totalPrice-=s.price):t.items.splice(i,1),t.totalQuantity-=1,t.totalPrice-=s.price}},resetCart(t){t.items=[],t.totalQuantity=0,t.totalPrice=0}}}),{addToCart:lV,removeFromCart:uV,resetCart:cV}=WI.actions,$4=WI.reducer,W4={name:"",phoneNumber:"",address:"",pincode:""},HI=Ii({name:"shippingAddress",initialState:{name:"",phoneNumber:"",address:"",pincode:""},reducers:{getShipping(t,e){return{...t,...e.payload}},resetShipping(t){return W4}}}),{getShipping:fV,resetShipping:hV}=HI.actions,H4=HI.reducer,qI=Ii({name:"order",initialState:{orders:[]},reducers:{setOrder(t,e){const{id:n,items:r,shippingAddress:i}=e.payload;t.orders.push({id:n,items:r,shippingAddress:i})}}}),{setOrder:dV}=qI.actions,q4=qI.reducer,K4={shippingAddress:{name:"",phoneNumber:"",address:"",pincode:""},errors:{}},KI=Ii({name:"validation",initialState:K4,reducers:{setValidationErrors(t,e){const{field:n,message:r}=e.payload;t.errors[n]=r},resetValidationErrors(t){t.errors={}}}}),{setValidationErrors:pV,resetValidationErrors:mV}=KI.actions,G4=KI.reducer,GI=Ii({name:"user",initialState:{user:null,error:null},reducers:{registerUser:(t,e)=>{t.user=e.payload}}});GI.actions;const Q4=GI.reducer,Y4=f2({reducer:{products:N2,currentpage:B4,cart:$4,shipping:H4,order:q4,validation:G4,user:Q4}});lh.createRoot(document.getElementById("root")).render(q.jsx(Ps.StrictMode,{children:q.jsx(Ib,{store:Y4,children:q.jsx(z4,{})})}));export{uo as L,X4 as a,kb as b,aV as c,lV as d,uV as e,RE as f,hV as g,fV as h,mV as i,q as j,cV as k,pV as l,Z4 as m,U4 as n,J4 as o,sV as p,rV as q,U as r,dV as s,oV as t,m1 as u,iV as v};
